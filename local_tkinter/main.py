...
def main() -> None:
    ...
    import_resume_button = screen.add_button(screen.import_resume, username, password, row=3, col=0, parent=left_frame, sticky="nsew", text="Import Resume")

    import_resume_button = screen.add_button(screen.import_resume, username, password, row=3, col=0, parent=right_frame, sticky="nsew", text="Create Resume")
